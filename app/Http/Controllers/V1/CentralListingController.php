...
class CentralListingController extends BaseController
{
    ...
    /**
     * @OA\Get (
     *     path="/main/api/v1/listings",
     *     summary="Display a listing of the resource.",
     *     description="Display a listing of the resource.",
     *     tags={"central/listings"},
    ...
    {
        return $this->successResponse(Listing::paginate());
    }
    ...
    /**
     * @OA\Get (
     *     path="/main/api/v1/listings/{listing}",
    ...
    public function update(Request $request, Listing $listing): JsonResponse
    {
        ...
        return $this->successResponse($listing->refresh());
    }
    ...
    {
        return $this->successResponse($listing->delete());
    }
}
